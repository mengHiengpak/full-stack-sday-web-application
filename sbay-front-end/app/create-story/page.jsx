  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex flex-col">
      <div className="bg-[var(--bg2)] border-b border-[var(--border)] h-14 flex items-center px-4 gap-3 flex-shrink-0">
        ...
        <span className="font-bold text-base text-[var(--text)]">Create Story</span>
        <button
          onClick={handlePost}
        ...
        <div className="flex-1 flex flex-col items-center justify-center bg-[var(--bg2)] border border-[var(--border)] rounded-lg min-h-[400px] relative overflow-hidden">
          {!preview ? (
            ...
            >
              ...
              <div className="text-lg font-semibold text-[var(--text2)]">Add to your story</div>
              <div className="text-sm text-[var(--text3)] mb-2">Drag photos and videos here</div>
